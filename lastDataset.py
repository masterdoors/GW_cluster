...
class dataset:
  ...
  def mkVocabs(self,args):
    ...
    generics =['<ROOT>', '<DIRECTION>', '<BENEFACTIVE>', '<ARGUMENT1>', '<ARGUMENT2>', '<ARGUMENT6>', '<ARGUMENT10>','<MANNER>', '<EXTENT>', '<ELABORATION>', '<SET>', '<ARGUMENT3>', '<LOCATION>', '<ARGUMENT4>', '<NAME>','<PURPOSE>', '<TIME>', '<NONCORE>']
    ...
    specials = ['ROOT', 'DIRECTION', 'BENEFACTIVE', 'ARGUMENT1', 'ARGUMENT2', 'ARGUMENT6', 'ARGUMENT10', 'MANNER', 'EXTENT', 'ELABORATION', 'SET', 'ARGUMENT3', 'LOCATION', 'ARGUMENT4', 'NAME', 'PURPOSE', 'TIME', 'NONCORE']
    for x in specials:
      for y in range(40):
        s = "<"+x+"_"+str(y)+">"
